  ...
  def self.attributes_list
    {
      ...
      :seek_time_performance => { :id => 8, :raw_name => "Seek_Time_Performance", :formatted_name => "Seek Time Performance", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 40, :type => :pre_fail, :unit => "Health%", :unit => "Health%", :updated => :offline,:raw => 0, :when_failed => '-'},
