  ...
  def self.attributes_list
    {
      ...
      :calibration_retry_count => {:id=>11, :raw_name=>"Calibration_Retry_Count", :formatted_name=>"Calibration Retry Count", :threshold_value=>253, :threshold_value_worst=>100, :threshold_level=>0, :type=>:old_age, :unit=>"count", :updated=>:always, :raw=>0, :when_failed=>"-"},
      ...
      :read_soft_error_rate => {:id=>13, :raw_name=>"Read_Soft_Error_Rate", :formatted_name=>"Read Soft Error Rate", :threshold_value=>100, :threshold_value_worst=>100, :threshold_level=>0, :type=>:old_age, :unit=>"rate", :updated=>:always, :raw=>270089920, :when_failed=>"-"},
