module Fixtures
  def self.attributes_list
    {
      :raw_read_error_rate => { :id => 1, :raw_name => "Raw_Read_Error_Rate", :formatted_name => "Raw Read Error Rate", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 62, :type => :pre_fail, :unit => "Health percent", :updated => :always,:raw => 0, :when_failed => '-'},
      :throughput_performance => {  :id => 2, :raw_name => "Throughput_Performance", :formatted_name => "Throughput Performance", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 40, :type => :pre_fail, :unit => "Health percent", :updated => :offline,:raw => 0, :when_failed => '-'},
      :spin_up_time => { :id => 3, :raw_name => "Spin_Up_Time", :formatted_name => "Spin Up Time", :threshold_value => 220, :threshold_value_worst => 220, :threshold_level => 33, :type => :pre_fail, :unit => "Health percent", :updated => :always, :raw => 1, :when_failed => '-'},
      ...
      :reallocated_sector_ct => { :id => 5, :raw_name => "Reallocated_Sector_Ct", :formatted_name => "Reallocated Sector Count", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 5, :type => :pre_fail, :unit => "Health percent", :updated => :always,:raw => 0, :when_failed => '-'},
      :seek_error_rate => { :id => 7, :raw_name => "Seek_Error_Rate", :formatted_name => "Seek Error Rate", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 67, :type => :pre_fail, :unit => "Health percent", :updated => :always,:raw => 0, :when_failed => '-'},
      :seek_time_performance => { :id => 8, :raw_name => "Seek_Time_Performance", :formatted_name => "Seek Time Performance", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 40, :type => :pre_fail, :unit => "Health percent", :unit => "Health percent", :updated => :offline,:raw => 0, :when_failed => '-'},
      :power_on_hours => { :id => 9, :raw_name => "Power_On_Hours", :formatted_name => "Power On Hours", :threshold_value => 98, :threshold_value_worst => 98, :threshold_level => 0, :type => :old_age, :unit => "Hours", :updated => :always,:raw => 1153, :when_failed => '-'},
      :spin_retry_count => { :id => 10, :raw_name => "Spin_Retry_Count", :formatted_name => "Spin Retry Count", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 60, :type => :pre_fail, :unit => "Health percent", :updated => :always,:raw => 0, :when_failed => '-'},
      ...
      :current_pending_sector => { :id => 197, :raw_name => "Current_Pending_Sector", :formatted_name => "Current Pending Sector", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 0, :type => :old_age, :unit => "Count", :updated => :always,:raw => 0, :when_failed => '-'},
      :offline_uncorrectable => { :id => 198, :raw_name => "Offline_Uncorrectable", :formatted_name => "Offline Uncorrectable", :threshold_value => 100, :threshold_value_worst => 100, :threshold_level => 0, :type => :old_age, :unit => "Count", :updated => :offline,:raw => 0, :when_failed => '-'},
